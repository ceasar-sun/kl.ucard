...
class block_stat_stu extends block_base {
    function init() {
        $this->title = get_string('pluginname','block_stat_stu');
    }
    ...
    function get_content() {
        ...
        $calculate  = get_string('STAT_STU_CAL','block_stat_stu');
        $semester  = get_string('STAT_STU_SEMTR','block_stat_stu');
        $academic_year = get_string('STAT_STU_AYEAR','block_stat_stu');
        $grade = get_string('STAT_STU_GRADE','block_stat_stu');
        $course_stat = get_string('STAT_STU_COURSE','block_stat_stu');
        ...
        $this->content->text .= '<form action="'.$CFG->wwwroot.'/blocks/stat_stu/view.php" style="display:inline">';
